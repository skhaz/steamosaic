...
renderInput = (element) => {
  ...
  firestore.collection('stats').doc('users')
    .onSnapshot((snapshot) => {
      document.getElementById('counter').innerHTML = snapshot.data().counter;
    });
}
